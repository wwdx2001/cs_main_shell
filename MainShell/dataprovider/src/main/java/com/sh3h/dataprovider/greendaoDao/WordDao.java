...
/** 
 * DAO for table "MS_WORD".
*/
public class WordDao extends AbstractDao<Word, Long> {

    public static final String TABLENAME = "MS_WORD";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MS_WORD\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MS_WORD\"";
        db.execSQL(sql);
    }
