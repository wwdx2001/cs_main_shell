...
import com.sh3h.datautil.data.model.Profile;
...
public class Db {
    ...
    public abstract static class RibotProfileTable {
        ...
        public static ContentValues toContentValues(Profile profile) {
            ...
            values.put(COLUMN_FIRST_NAME, profile.name);
            values.put(COLUMN_LAST_NAME, profile.name);
        ...
        public static Profile parseCursor(Cursor cursor) {
            ...
            profile.name = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_FIRST_NAME));
            profile.name = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_LAST_NAME));
