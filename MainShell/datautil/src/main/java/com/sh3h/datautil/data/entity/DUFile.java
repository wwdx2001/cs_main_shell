...
public class DUFile {
    ...
    private boolean isDownloadingNewly;
    ...
    public DUFile(FileType fileType, String appName, String appId, String packageName,
                  ...
                  boolean needDownloadOtherFiles, boolean isDownloadingNewly) {
        ...
        this.isDownloadingNewly = isDownloadingNewly;
    }
    ...
    public boolean isDownloadingNewly() {
        return isDownloadingNewly;
    }

    public void setDownloadingNewly(boolean downloadingNewly) {
        isDownloadingNewly = downloadingNewly;
    }
}
