...
import com.sh3h.datautil.data.entity.result.DUTracksResult;
...
public interface RestfulApiService {
    ...
    Observable<DUEntityResult<DUTokenResult>> checkToken(@Body DUTokenInfo duTokenInfo);
     ...
     */
    @POST("logout")
    Observable<DUEntityResult<Boolean>> logout(@Body DULogoutInfo duLogoutInfo);
