...
public class ApkInstallationActivity extends ParentActivity
    ...
    @BindView(R.id.toolbar_apk_install)
    Toolbar mToolbar;
    ...
    private class MyApkListAdapter extends RecyclerView.Adapter<RecyclerViewHolder> implements View.OnClickListener {
        ...
        public void onBindViewHolder(RecyclerViewHolder holder, int position) {
            ...
            Picasso.with(mContext) //
                    .load(duApkInfoResultEx.getIconUrl()) //
                    ...
                    .onPositive(new MaterialDialog.SingleButtonCallback() {
                        ...
                        public void onClick(@NonNull MaterialDialog materialDialog,
                            ...
                            downloadFiles(duApkInfoResultEx.getAppName(), duApkInfoResultEx.getAppId(),
                                    ...
                                    duApkInfoResultEx.getVersionName(), duApkInfoResultEx.getAppUrl(),
                                    duApkInfoResultEx.getDataUrl(), true);
                        }
                    })
                    .onNegative(new MaterialDialog.SingleButtonCallback() {
                        ...
                        public void onClick(@NonNull MaterialDialog materialDialog,
                            ...
                            downloadFiles(duApkInfoResultEx.getAppName(), duApkInfoResultEx.getAppId(),
                                    duApkInfoResultEx.getPackageName(), duApkInfoResultEx.getVersionCode(),
                                    duApkInfoResultEx.getVersionName(), duApkInfoResultEx.getAppUrl(),
                                    duApkInfoResultEx.getDataUrl(), false);
                        }
                    })
                    .show();
        }
    ...
    private void deleteApk(String packageName) {
        try {
            if (mApkInstallationPresenter.isAtlasMode() && (packageName.lastIndexOf(".bundle") != -1)) {
                MainApplication.get(this).unloadAtlasBundle(packageName);
            } else {
