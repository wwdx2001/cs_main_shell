...
public class ArrearAge {
    ...
    @NotNull
    private int BILLING_MONTH;//财务年月
    ...
    @NotNull
    private long BANK_SEND_TIME;//送盘时间
    ...
    @Generated(hash = 949314844)
    public ArrearAge(Long ID, int FEE_ID, @NotNull String CARD_ID,
            ...
            int LAST_READ_STATE, long LAST_READ_DATE, int READING, int READ_STATE,
            @NotNull String READ_STATE_CN, long READ_DATE, int METER_READER,
            int RECORD_ENTRY_USER, int NEXT_READ_DATE, int ACC_WATER,
            double LAST_BALANCE, double BALANCE, double ACC_MONEY,
            double ACC_CHECK_MONEY, long CHECK_TIME, int CHECK_DATE,
            int CHECK_USER, double PI_1MONEY, double PI_2MONEY, double PI_3MONEY,
            double PI_4MONEY, double PI_5MONEY, double PI_6MONEY,
            long CHARGE_LIMIT_DATE, double DUELATE_FEE, double DELATE_FEE,
            double ACTUALLY_LATE_FEE, long PAY_TIME, int PAY_DATE, int CASHIER,
            int PWID, int PST_METHOD, int PAY_STATE, int PSUB_TOTALLD,
            int P_TOTALLD, long CHARGE_TIME, int PRINT_TIMES, long PRINT_DATE,
            @NotNull String INVOICE_CODE, int INVOICE_YEAR,
            @NotNull String INVOICE_NUMBER, int BANK_BATCH_FLAG, int BANK_BATCH_ID,
            long BANK_SEND_TIME, int LAST_FEE_ID, int ORIGINAL_FEE_ID,
            int ADJUST_ID, int ADJUST_TYPE, int FEE_STATE, int PROCESS_STATE,
            boolean IS_VAT_USER, int PERSON_COUNT) {
        this.ID = ID;
        this.FEE_ID = FEE_ID;
