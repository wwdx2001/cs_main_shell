...
/** 
 * DAO for table "MR_ARREARAGE".
*/
public class ArrearAgeDao extends AbstractDao<ArrearAge, Long> {

    public static final String TABLENAME = "MR_ARREARAGE";

    /**
     * Properties of entity ArrearAge.<br/>
    ...
    public ArrearAgeDao(DaoConfig config) {
        super(config);
    }
    
    public ArrearAgeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MR_ARREARAGE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MR_ARREARAGE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ArrearAge entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ArrearAge entity) {
        stmt.clearBindings();
    ...
    @Override
    public ArrearAge readEntity(Cursor cursor, int offset) {
        ArrearAge entity = new ArrearAge( //
    ...
    @Override
    public void readEntity(Cursor cursor, ArrearAge entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ArrearAge entity, long rowId) {
        entity.setID(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ArrearAge entity) {
        if(entity != null) {
            return entity.getID();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ArrearAge entity) {
