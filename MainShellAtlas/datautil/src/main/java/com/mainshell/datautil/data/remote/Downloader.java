...
import com.mainshell.datautil.data.entity.DUUpdateInfo;
import com.mainshell.datautil.data.entity.DUUpdateResult;
            ...
            public void call(Subscriber<? super DUFileResult> subscriber) {
                ...
                try {
                    if (duFile.getFileType() == DUFile.FileType.APK) {
                        if (!duFile.isDownloadingNewly() && checkLocalApk(duFile)) {
