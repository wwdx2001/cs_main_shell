package com.mainshell.datautil.data.local.xml;
        ...
        return Observable.create(new Observable.OnSubscribe<Boolean>() {
            ...
            public void call(Subscriber<? super Boolean> subscriber) {
                ...
                try {
                    ...
                    boolean isAtlasMode = mConfigHelper.isAtlasMode();
                    ...
                    for (DUUpdateXmlFile.Application application : applicationList) {
                        ...
                        if (isAtlasMode && !application.getPackageName().equals(mContext.getPackageName())) {
                            File bundleFile = new File(mConfigHelper.getApksFolderPath(),
                                    application.getPackageName().replace(".", "_") + ".so");
