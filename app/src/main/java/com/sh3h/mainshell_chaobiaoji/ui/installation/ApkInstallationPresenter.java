...
//import com.sh3h.datautil.data.entity.DUApkFile;
    ...
    private List<DUApkInfoResultEx> convertToApkInfoList(List<DUApkInfoResult> duApkInfoResultList) {
        ...
        for (DUApkInfoResult duApkInfoResult : duApkInfoResultList) {
            if (TextUtil.isNullOrEmpty(duApkInfoResult.getAppName())
                    ...
                    || TextUtil.isNullOrEmpty(duApkInfoResult.getIconInnerUrl())
                    || TextUtil.isNullOrEmpty(duApkInfoResult.getIconOuterUrl())
                    || TextUtil.isNullOrEmpty(duApkInfoResult.getAppInnerUrl())
                    || TextUtil.isNullOrEmpty(duApkInfoResult.getAppOuterUrl())
//                    || TextUtil.isNullOrEmpty(duApkInfoResult.getConfigUrl())
                    || TextUtil.isNullOrEmpty(duApkInfoResult.getDataInnerUrl())
                    || TextUtil.isNullOrEmpty(duApkInfoResult.getDataOuterUrl())) {
                continue;
            }
