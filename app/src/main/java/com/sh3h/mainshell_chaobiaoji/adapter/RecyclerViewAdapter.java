...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ItemViewHolder>
    ...
    public RecyclerViewAdapter(List<DUConfigXmlFile.Component> components,
                               Context mContext, boolean isGreenTheme) {
        this.mComponents = components;
        this.mContext = mContext;
        this.mInflater = LayoutInflater.from(mContext);
        this.mOnItemClickListener = null;
        this.mOnDataChangedListener = null;
        this.mIsGreenTheme = isGreenTheme;
    }
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ConstDataUtil.TYPE_LIST_VIEW) {
            //listView
            resource = mIsGreenTheme ? R.layout.gridview_item_list_green : R.layout.gridview_item_list;
