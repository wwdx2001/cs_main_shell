...
//        Schema schema = new Schema(1,"com.sh3h.dataprovider.greendaoEntity");
//        schema.setDefaultJavaPackageDao("com.sh3h.dataprovider.greendaoDao");
//
...
//        new DaoGenerator().generateAll(schema, "../MainShell/dataprovider/src/main/java");
//
//    }
//
